...
![A copepod infected with *S. solidus* - infected copepods were fed to threespine stickleback](Copepod.jpg)
...
My undergraduate mentee's research project was accepted for publication at *PeerJ*! Sara and I worked together to design and test whether the tapeworm *S. solidus* use quorum sensing to initiate hatching. We predicted that eggs in higher densities would exhibit higher hatching rates. While we found no effect of density on hatch rates, I think this was an exciting experiment with some really interesting evolutionary predictions and implications. I'm proud that I was able to co-first author a peer-reviewed paper with a mentee, and publish a null result in a widely-read and respected journal. To learn more, check out our [manuscript](https://peerj.com/articles/20667/)!
...
I am honored to receive Honorable Mention from the National Science Foundation's 2022 Graduate Research Excellence Program. While not funded, it's exciting that the NSF acknowledged my potential as a researcher and seriously considered funding my project ideas regarding the how DNA methylation mediates plasticity, heritability, and selection. Congrats to all of the awardees!
